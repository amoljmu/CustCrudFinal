...
import com.amol.myapp.service.CustomerService;
import com.amol.myapp.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.amol.myapp.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public ResponseEntity<Customer> createCustomer(@Valid @RequestBody Customer customer) throws URISyntaxException {
        ...
        if (!customer.getDateOfBirth().isBefore(Instant.now())) {
			throw new BadRequestAlertException("Date of Birth Should be Backdated", ENTITY_NAME, "dobBackdated");
	   }
